...
print(f"Game Normal Screen loading")
...
class CheckTimerRequestThread(QThread):
    ...
    def run(self):
        ...
        while True:
            try:
                print(">>> normal_screen - Checking timer request response ")
                ...
                if "401 Client Error" in str(request_error):
                    ...
                    print(">> normal_screen - Not a 401 error")
...
class NormalWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # start thread without blocking for WebsocketClient
        self.WebsocketClient_thread = threads.WebsocketClientThread()
        ...
        # # widget
        # if PLATFORM == "Intel":
        #     self.master_video_player = mpv.MPV(wid=str(int(self.winId())),
        #                                        hwdec=config["hwdec"],
        #                                        vo=config["vo"],
        ...
        #                                        )
        #     self.master_picture_displayer = mpv.MPV(wid=str(int(self.winId())),
        #                                             hwdec=config["hwdec"],
        #                                             vo=config["vo"],
        #                                             input_default_bindings=True,
        #                                             input_vo_keyboard=True,
    ...
    def start_master_threads(self):
        ...
        self.WebsocketClient_thread.start()
    ...
    def master_media_files(self):
        ...
        #                        "assets/application data/device_configurations.json")) as device_configurations_json_file:
        #     initial_dictionary = json.load(device_configurations_json_file)

        room_info_response = threads.DEVICE_CONFIG
